...
class DeviceLoginScreen extends StatefulWidget {
  const DeviceLoginScreen({Key? key}) : super(key: key);

  @override
  _DeviceLoginScreenState createState() => _DeviceLoginScreenState();
}
...
class LoginButton extends StatelessWidget {
  const LoginButton({Key? key, required this.id, required this.isEnabled}) : super(key: key);
    ...
    return Container(
      ...
      child: GradientSmallButton(
        ...
        onPressed: () async {
          ...
          await prefs.setString('empname', '관리자');
