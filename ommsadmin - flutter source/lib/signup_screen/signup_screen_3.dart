  ...
  void initState() {
    Future.delayed(Duration.zero, () async {
      setState(() {
        ...
        _nameController.text = Provider.of<CurrentUser>(context, listen: false).name;
        _heightController.text = Provider.of<CurrentUser>(context, listen: false).height;
        _weightController.text = Provider.of<CurrentUser>(context, listen: false).weight;
        dateTime = Provider.of<CurrentUser>(context, listen: false).birthDate;
        gender = Provider.of<CurrentUser>(context, listen: false).isMale ? Gender.male : Gender.female;
        if (dateTime != '') {
          isBirthDate = true;
        }
        isLoading = false;
              ...
              Row(
                children: [
                  ElevatedButton(
                    ...
                    onPressed: () {
                      DatePickerBdaya.showDatePicker(context, showTitleActions: true, minTime: DateTime(1900, 1, 1), maxTime: DateTime(2021, 12, 31), onChanged: (date) {}, onConfirm: (date) {
                        setState(() {
